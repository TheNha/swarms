...
6. Build task list
7. **Classify each task** as `design` or `standard` based on the rules above
8. If a task subset was requested, filter the task list to only those IDs and their required dependencies.
...
/co-design plans/YYYY-MM-DD-HH-MM-topic/plan.md
